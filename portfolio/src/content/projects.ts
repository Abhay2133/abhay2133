export const projects = [
  {
    ...
    description: "A modern, responsive portfolio website built with Vue 3, TypeScript, and TailwindCSS featuring dark mode and smooth animations.",
  ...
  },
  {
    ...
    description: "A full-stack task management application with real-time updates, user authentication, and team collaboration features.",
  ...
  },
  {
    ...
    description: "A comprehensive e-commerce solution with product management, shopping cart, payment integration, and admin dashboard.",
